    ...
    <>
      <nav className="app__navbar">
        ...
        <div className="app__navbar-menu">
          <HiMenuAlt4 className="open-btn" onClick={() => setToggle(true)} />
          ...
          { toggle && (
            ...
            >
              <HiX className='close-btn' onClick={() => setToggle(false)} />
              <ul>
                ...
                <li className="app__flex estimate ">
                  <img src={navImages[3]} alt="" className="nav-menu-icon" />
                  <a href onClick={() => setOpenModal(true)} style={{cursor: 'pointer'}} className="lexend-semi-bold-watercourse-14px nav-text-item">
                    Free Estimate
                  </a>
                </li>
              ...
              <div className="menu-contact-details">
                <div className="menu-contact-title lexend-semi-bold-midnight-18px">
                  Contact
                </div>
                <div className="menu-contact-item">
                  <svg width="35" height="35" viewBox="0 0 19 18" fill="none" className="menu-contact-icon" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="menu-contact-text lexend-normal-oslo-gray-14px">9286 Stuart Crescent Surrey BC V3V 1T6</div>
                </div>
                <div className="menu-contact-item">
                  <svg width="35" height="35" viewBox="0 0 24 24" className="menu-contact-icon" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="menu-contact-text lexend-normal-oslo-gray-14px">(778) 829-6747</div>
                </div>
                <div className="menu-contact-item">
                  <svg width="35" height="35" viewBox="0 0 19 18" className="menu-contact-icon" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="menu-contact-text lexend-normal-oslo-gray-14px">eaglepropaintingltd@gmail.com</div>
                </div>
              </div>
